...
export function Navbar() {
    ...
    return (
        <nav className="fixed top-0 z-40 w-full bg-white/80 backdrop-blur-sm dark:bg-zinc-950/80 border-b border-zinc-200 dark:border-zinc-800">
            <div className="container mx-auto flex h-18 items-center justify-between px-6 md:px-0">
