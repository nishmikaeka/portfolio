                  ...
                  >
                    {typeof tech.icon === "function" ? (
                      <tech.icon
                        style={{
                          color:
                            tech.color === "#000000" ? undefined : tech.color,
                        }}
                        className={
                          tech.color === "#000000" ? "dark:text-white" : ""
                        }
                      />
                    ) : (
                      <Image
