...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative flex min-h-[calc(100vh-150px)] w-full flex-col items-center justify-center overflow-hidden px-6 pt-0 sm:pt-15 lg:px-24"
    >
      {/* Content Container */}
      <div className="z-10 flex w-full max-w-4xl flex-col items-center gap-1 text-center">
        ...
        >
          &quot;Junior Full-Stack Developer building high-performance
          applications with a focus on exceptional UX and community-driven
          solutions.&quot;
        </motion.p>
      </div>
